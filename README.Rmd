...
```
Because calling ```wrap``` unprotects the underlying R vector, it is a good idea to protect the result unless it is immediately returned. I get the following:
```
