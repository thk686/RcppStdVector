...
// [[Rcpp::export]]
void test_copy_ivec(RcppStdVector::std_ivec_int& x,
                    RcppStdVector::std_ivec_int& y) {
  x = y;
}

// [[Rcpp::export]]
RcppStdVector::std_ivec_int
test_copy_const_ivec(RcppStdVector::std_ivec_int& x) {
  RcppStdVector::std_ivec_int y(x);
  return y;
}
